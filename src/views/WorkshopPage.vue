<template>
  <div>
    <div class="header">
      <h1 class="header__title">einfachIOTA Workshop</h1>
...
var options = {
  owner: "einfachIOTA",
  repo: "iota-workshop",
  branch: "einfachIOTA" // defaults to master
};
  ...
  methods: {
    async fetchData() {
      ...
      if (this.workshop == undefined) {
        file_path = "docs/de/README.md";
      } else {
        file_path = "docs/de" + this.workshop;
      }
  ...
  mounted() {
    window.addEventListener("click", event => {
      ...
      if (
        ...
        this.$router.push({
          name: "WorkshopPage",
          params: { workshop: target.pathname }
        });
